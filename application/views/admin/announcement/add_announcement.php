    ...
    <div class="row">
        <div class="col-lg-8 col-xs-10">
			...
			<?php } ?>
                ...
                <form id="add_announcement_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/announcement/add_announcement">          
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="announcement Title" class="form-control input-sm br0" size="30" id="announcement_title" value="" name="announcement_title" required/>                            
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                             <textarea placeholder="Description" class="form-control input-sm br0"  id="announcement_description" value="" name="announcement_description" required></textarea> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                 <input type="submit" class="btn btn-info br0 on_sending_reg" value="Add announcement" name="submit"/> 
                              </div>
                        </div>
                    </form> 
            </div><!-- ./col -->

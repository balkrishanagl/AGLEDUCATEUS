    ...
    <div class="row">
		...
		<?php if(isset($file_error)){ 
			...
			<?php } ?>
                ...
                <form id="add_user_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/assignment/add_assignment/" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="cal_event_datetime" class="col-md-4 control-label"><label for="username">Filename</label></label>
                            <div class="col-md-5">
                                <input type="text" placeholder="Filename" class="form-control input-sm br0" size="30" id="filename" value="<?php echo set_value('filename'); ?>" name="filename" required/>                            
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" placeholder="Caption" class="form-control input-sm br0" size="30" id="caption" value="<?php echo set_value('caption'); ?>" name="caption" required/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                ...
                                <p class="form_er_msg" id="error_password">Allowed Type:- PDF/DOC/DOCX/DOC/DOCX Max Size:-10 MB</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                 <input type="submit" class="btn btn-info br0 on_sending_reg" value="Add Assignment" name="submit"/> 
                            </div>
                        </div>
                    </form> 
            </div><!-- ./col -->

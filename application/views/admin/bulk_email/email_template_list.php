...
<section class="content">
	...
	<div class="box-body table-responsive">
		...
		<tr>
			...
			<?php if($TempList->status=='Active'){ ?>
			|<a href="javascript:void(0);" onclick="delete_template(<?php echo $TempList->id ?>)">Inactive</a>
			<?php }else{ ?>
			&nbsp;|&nbsp;<a href="javascript:void(0);" onclick="active_template(<?php echo $TempList->id ?>)">Active</a>
			<?php } ?>

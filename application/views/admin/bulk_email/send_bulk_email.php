    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-xs-10">
			...
			<?php } ?>
                ...
                <form id="add_page_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/email_template/send_bulk_email" enctype= "multipart/form-data">          

                        <div class="form-group">
							<label for="cal_event_info" class="col-md-4 control-label"><label for="status">Email Template</label></label>
								<div class="col-md-8">
								<select class="form-control" name="email_template" id="email_template">
									<option value=""> Select Email Template</option>
								<?php foreach($email_template as $email_templates){?>
									<option value="<?php echo $email_templates->id;?>"><?php echo $email_templates->email_title;?></option>
								<?php } ?>	
								</select>
						</div>
						</div>
						<div class="form-group">
							...
							<span>Exhibitor</span> &nbsp; <input type="radio" value="exhibitor" name="type"> &nbsp;
							<span>Both</span> &nbsp; <input type="radio" value="register exhibitor users" name="type"> &nbsp;
						...
						<div class="form-group" id="user_email_file" style="display: none;">
							...
							<a href="<?php echo base_url().'assets/bulk_email.csv'; ?>" download>Download Sample Excel</a>
                            </div>
                        </div>

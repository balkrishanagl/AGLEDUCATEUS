    ...
    <div class="row">
        <div class="col-lg-8 col-xs-10">
			...
			<?php } ?>
                ...
                <form id="add_client_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/client/edit_relation/<?php echo $relation_data->id?>"  enctype="multipart/form-data">          
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<?php foreach($team_members as $team_member){ ?>
									<option value="<?php echo $team_member->id; ?>" <?php if($team_member->id == $relation_data->team_member_id){ echo 'selected'; }?>><?php echo $team_member->name; ?></option>
								<?php } ?>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<?php foreach($clients as $client){ ?>
									<option value="<?php echo $client->id; ?>" <?php if($client->id == $relation_data->client_id){ echo 'selected'; }?>><?php echo $client->client_name; ?></option>
								<?php } ?>
								</select>
							</div>
						</div>

    ...
    <div class="row">
        <div class="col-lg-8 col-xs-10">
			...
			<?php } ?>
                ...
                <form id="add_counselor_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/counselor/add_counselor" enctype= "multipart/form-data">          
                        <div class="form-group">
                            <label for="cal_testimonial_datetime" class="col-md-4 control-label"><label for="name">Name</label></label>
                            <div class="col-md-8">
                                <input type="text" placeholder="Name" class="form-control input-sm br0" size="30" id="title" value="<?php echo set_value('title'); ?>" name="title" required/>                            
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Designation" class="form-control input-sm br0" size="30" id="designation" value="<?php echo set_value('designation'); ?>" name="designation" required/>                            
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                             <textarea placeholder="Description" class="form-control input-sm br0"  id="description" value="<?php echo set_value('description'); ?>" name="description" required></textarea> 
                            </div>
                        </div>												<div class="form-group">                            <label for="cal_testimonial_datetime" class="col-md-4 control-label"><label for="name">Website</label></label>                            <div class="col-md-8">                                <input type="text" placeholder="Website" class="form-control input-sm br0" id="website" value="<?php echo set_value('website'); ?>" name="website" />                                                                                     </div>                       </div>					   					   <div class="form-group">                            <label for="cal_testimonial_datetime" class="col-md-4 control-label"><label for="name">Phone</label></label>                            <div class="col-md-8">                                <input type="text" placeholder="Phone Number" class="form-control input-sm br0" id="phone" value="<?php echo set_value('phone'); ?>" name="phone" />                                                                                     </div>                       </div>					   					   <div class="form-group">                            <label for="cal_testimonial_info" class="col-md-4 control-label"><label for="description">Skills</label></label>                            <div class="col-md-8">                             <textarea placeholder="Skills" class="form-control input-sm br0"  id="skills" value="<?php echo set_value('skills'); ?>" name="skills"></textarea>                             </div>                        </div>

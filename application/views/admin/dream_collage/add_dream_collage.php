...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
           Dream collages
            <small>Add Dream collage</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url()?>admin/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo base_url()?>admin/dream_collage/manage_dream_collage"><i class="fa fa-dashboard"></i> Dream collages</a></li>
    ...
    <div class="row">
		...
		<?php if(isset($file_error)){ 
			...
			<?php } ?>
                ...
                <form id="add_collage_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/dream_collage/add_dream_collage"  enctype="multipart/form-data">          
                       
											
					   <div class="form-group">
                            <label for="cal_insurance_partner_datetime" class="col-md-4 control-label"><label for="collage title">Title</label></label>
                            <div class="col-md-8">
                                <input type="text" placeholder="Title" class="form-control input-sm br0" size="30" id="collage_title" value="<?php echo set_value('collage_title'); ?>" name="collage_title" />                            

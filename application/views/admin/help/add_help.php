    ...
    <div class="row">
        <div class="col-lg-8 col-xs-10">
			...
			<?php } ?>
                ...
                <form id="add_help_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/help/add_help" enctype= "multipart/form-data">          
                        <div class="form-group">
                            <label for="cal_testimonial_datetime" class="col-md-4 control-label"><label for="name">Title</label></label>
                            <div class="col-md-8">
                                <input type="text" placeholder="title" class="form-control input-sm br0" size="30" id="help_title" value="" name="help_title" required/>                            

...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            IP Competition
            <small>Add IP Competition</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">Add IP Competition</li>
        </ol>
    </section>
    ...
    <div class="row">
		...
		<?php if(isset($file_error)){ 
			...
			<?php } ?>
                ...
                <form id="add_competition_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/ip_competition/add_competition" enctype= "multipart/form-data">          
                        <div class="form-group">
                            <label for="cal_event_datetime" class="col-md-4 control-label"><label for="coverage title">Title</label></label>
                            <div class="col-md-8">
                                <input type="text" placeholder="Competition Title" class="form-control input-sm br0" size="30" id="competition_title" value="" name="competition_title" required/>                            
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
							<?php echo $this->ckeditor->editor('competition_content',@$default_value);?>                              
                            </div>
                        </div>

...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
           Participat collages
            <small>Add Participat collage</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <div class="row">
		...
		<?php if(isset($file_error)){ 
			...
			<?php } ?>
                ...
                <form id="add_collage_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/participat_collage/add_participat_collage"  enctype="multipart/form-data">          
                        <div class="form-group">
                            <label for="cal_insurance_partner_datetime" class="col-md-4 control-label"><label for="collage title">Title</label></label>
                            <div class="col-md-8">
                                <input type="text" placeholder="Partner Title" class="form-control input-sm br0" size="30" id="collage_title" value="<?php echo set_value('collage_title'); ?>" name="collage_title" />                            

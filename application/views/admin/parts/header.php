...
<html>
    <head>
        ...
        <title>EDUCATEUS | Dashboard</title>
    ...
    <body class="skin-blue">
                    ...
                    <!--    <li class="dropdown tasks-menu">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?php if(isset($name)) { echo $name; } ?> <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
							...
							<?php } ?> <p>
                                        <?php if(isset($name)){echo $name;}?> - <?php if(isset($usertype)){echo $usertype;}?>
                                        <small>Member since <?php echo date('d-m-Y',strtotime($create_datetime));?></small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                              <!--  <li class="user-body">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo base_url();?>admin/user_profile/<?php if(isset($userid)) { echo $userid; } ?>" class="btn btn-default btn-flat">Profile</a>
                                    </div>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left"> <!-- main div start --> 
        <!-- close in footer -->
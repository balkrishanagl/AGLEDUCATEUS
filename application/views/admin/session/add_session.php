    ...
    <div class="row">
        <div class="col-lg-8 col-xs-10">
			...
			<?php } ?>
                ...
                <form id="add_session_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/session/add_session">          
                        <div class="form-group">
                            <label for="Session Name" class="col-md-4 control-label"><label for="session name">Name</label></label>
                            <div class="col-md-8">
                                <input type="text" placeholder="Session Name" class="form-control input-sm br0" size="30" id="session_name" value="" name="session_name" >                            
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text"  class="form-control input-sm br0" size="30" id="session_start_on" value="" name="session_start_on" />                            
						...
						<div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text"  class="form-control input-sm br0" size="30" id="session_end_on" value="" name="session_end_on" />                            
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text"  class="form-control input-sm br0" size="30" id="registration_start_on" value="" name="registration_start_on" />                            
						...
						<div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text"  class="form-control input-sm br0" size="30" id="registration_end_on" value="" name="registration_end_on" />                            

			...
			<?php } ?>
                ...
                <form id="add_slider_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>admin/slider/add_slider" enctype= "multipart/form-data">          
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Banner Name" class="form-control input-sm br0" size="30" id="banner_name" value="<?php echo set_value('banner_name'); ?>" name="banner_name" required/>                            
					    ...
					    <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="URL" class="form-control input-sm br0" id="url" value="<?php echo set_value('url'); ?>" name="url">                            
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Image caption" class="form-control input-sm br0" size="30" id="img_caption" value="<?php echo set_value('img_caption'); ?>" name="img_caption" required/>                            
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea placeholder="slider Content" id="banner_content" class="form-control input-sm br0" name="banner_content"><?php  if(set_value('banner_content')){ echo set_value('banner_content'); }?></textarea>
                   ...
                   <div class="form-group">
                            ...
                            <div class="col-md-8">
								...
								<span class="form_er_msg" id="error_password">Image type:- jpg/JPEG/gif/png. Max Size:- 500 KB Max Height And Width(661x1919) </span>
                            </div>
                       </div>

...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            ...
            <small><a href="<?php echo base_url();?>admin/source_information/add_source">Add source info</a></small>
            <?php } ?>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url()?>admin/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">source of Information List</li>
        </ol>
    </section>
...
<section class="content">
    ...
    <h3 class="box-title">source of Information List</h3>
	</div><!-- /.box-header -->
	...
	<div class="box-body table-responsive">
		...
		<th>Order</th>
		<th>Status</th>
		<?php if($user_session_data['user_type_id'] == '1' or $user_session_data['user_type_id'] == '7'){ ?>
        <th>Action</th>
        <?php } ?>
		</tr>
		</thead>
		...
		<tr>
			...
			<td><?php echo $source_detail->name;?></td>
			<td><?php echo $source_detail->count;?></td>
			<td><?php echo $source_detail->order_no;?></td>
			<td><?php if($source_detail->status==1){ echo "Active"; } else { echo "Inactive"; } ?></td>
			<?php if($user_session_data['user_type_id'] == '1' or $user_session_data['user_type_id'] == '7'){ ?>
			<td><a href="<?php echo base_url(); ?>admin/source_information/edit_source/<?php echo $source_detail->id;?>">Edit</a>
			<?php if($user_session_data['user_type_id'] == '7'){ ?>
				&nbsp;|&nbsp;<a href="javascript:void(0);" onclick="delete_source(<?php echo $source_detail->id; ?>)">Delete</a>
			<?php } ?>
			</td>
			<?php } ?>
		</tr>    
...
function delete_source(id){
	...
	if(r==true){
		window.location.href = '<?php echo base_url(); ?>admin/source_information/delete_source/'+id;
	}
}
    $(function() {
        $("#example1").dataTable();

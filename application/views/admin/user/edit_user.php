    ...
    <div class="row">
		...
		<div>
			...
			<?php } ?>
                ...
                <form id="edit_user_form" class="form-horizontal" accept-charset="utf-8" method="post" action="<?php echo base_url();?>admin/user/edit_user/<?php echo $user_data->id;?>">          
                        <div class="form-group">
                            <label for="cal_event_datetime" class="col-md-4 control-label"><label for="username">Name</label></label>
                            <div class="col-md-5">
                                <input type="text" placeholder="Name" class="form-control input-sm br0" size="30" id="name" value="<?php if(isset($user_data)) { echo $user_data->name; }?>" name="name"/>                            
                        ...
                        <div class="form-group">
                               ...
                               <select class="form-control" name="city" id="city">
                                    <?php if(isset($city_data) && $city_data != NULL) {?>
                                        ...
                                        <?php foreach($city_data as $allCity){
											...
											?>
                                            <option value="<?php echo $allCity->id; ?>" <?Php if($allCity->id == $user_data->city){ echo "selected"; }?>><?php echo $allCity->city_name; ?></option>
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" placeholder="Phone Number" class="form-control input-sm br0"  id="phone" value="<?php if(isset($user_data)) { echo $user_data->phone; }?>" name="phone"/>                            
                                <span class="form_er_msg" id="error_username"></span>
                            </div>
                       </div>
					   ...
					   <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <textarea  class="form-control input-sm br0" name="address" id="address"><?php if(isset($user_data)) { echo $user_data->address; }?></textarea>
                            </div>
                       </div>
					   ...
					   <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" placeholder="Pincode" class="form-control input-sm br0"  id="pincode" value="<?php if(isset($user_data)) { echo $user_data->pincode; }?>" name="pincode"/>                            

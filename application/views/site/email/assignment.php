...
<title>Assignment Submission <?php echo $site_name; ?>!</title>
</head>
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #f5821f; padding:0 15px;">
  ...
  <tr>
    <td align="left" style="font:normal 13px Arial, Helvetica, sans-serif; color:#000;"><p>Dear <?php echo trim($name);?>, <br />
      <br />
This is to confirm the submission of assignment for (<?php echo $site_name; ?>).
You will be informed about the final scores at the end of the final examination.
In case of any help required, feel free to contact course coordinator.
<br />

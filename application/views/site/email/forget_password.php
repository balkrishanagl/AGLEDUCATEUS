...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #f5821f; padding:0 15px;">
  ...
  <tr>
  <td>
  <h4 style="font:bold 20px Arial, Helvetica, sans-serif; color:#000; text-align:center">Forgot Password <?php echo $site_name; ?></h4>
  </td>
  </tr>
  ...
  <tr>
    <td align="left" style="font:normal 13px Arial, Helvetica, sans-serif; color:#000;"><p>Dear <?php echo trim($name); ?>, <br />
      <br />
	<strong>Your new password is: <?php echo $password; ?></strong> <br/>
	Thanks for using automatic password retrieval system.<br /> <br />
	Note : This is an automated mailer. Please do not reply to this mail.<br /> <br />

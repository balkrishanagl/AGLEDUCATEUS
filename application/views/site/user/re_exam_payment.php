...
<div class="reg paylist">
        ...
        <form id="frmPayment" name="frmPayment" method="POST" action="<?php echo base_url(); ?>student/re_exam_payment/" data-toggle="validator" role="form">
          <ul>
		   ...
		   function change_chk(){
			 ...
			 <li>
				  <label>Re Exam Fees <sup>*</sup></label>
				  <div class="form-group">
			...
			<li>
				  ...
				  <div class="form-group">
				  <input id="bankname" name="bankname" pattern="^[a-zA-Z. ]+$" data-pattern-error="Please Enter Valid Bank Name" value="<?php echo set_value('bankname'); ?>" placeholder="Bank Name" required type="text">
				  <div class="help-block with-errors"></div>
				  </div>
			</li> 
			...
			<li>
				  ...
				  <div class="form-group">
				  <input id="branchname" name="branchname" value="<?php echo set_value('branchname'); ?>" placeholder="Branch Name" pattern="^[a-zA-Z. ]+$" data-pattern-error="Please Enter Valid Branch Name" required type="text">
				  <div class="help-block with-errors"></div>
				  </div>
			</li> 
			 <li>
